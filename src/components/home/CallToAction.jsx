  ...
  return (
    <div className="    flex flex-col items-center justify-between py-16 px-4 sm:px-8 lg:px-16 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full   mx-auto mb-24">
        ...
        <button className="bg-blue-200 text-black px-8 py-4 rounded-full text-lg font-medium hover:bg-blue-300 transition-colors duration-300">
          Let's talk!
        </button>
      </div>
      ...
      {/* Contact Information */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl mx-auto mb-24">
        {/* Email */}
